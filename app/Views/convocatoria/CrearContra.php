...
<div class="login-box">
  ...
  <div class="card">
    <div class="card-body login-card-body">
      <p class="login-box-msg">Crear Contraseña</p>

      <form id="formContra"action="" method="post">
        ...
        <div class="row">  
          <!-- /.col -->
          <div class="col-12">
            <button type="button" class="btn btn-success btn-block" onclick="enviar();">Crear</button>
          </div>
          <!-- /.col -->
        </div>
      </form>
...
<script src="<?php echo base_url(); ?>/public/myjs/login.js"></script>
</body>
</html>