        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
               <form class="form-horizontal" action="<?php echo base_url();?>/Perfil/add" method="post">
                ...
                <div class="card-body">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" value="<?php echo $perfil?>" name="perfil" id="perfil" placeholder="Perfil" onkeypress="return Letras(event);" required>
                    </div>
                   ...
                   <div class="form-group row">
                    ...
                    <div class="col-sm-10 select2-primary">
                      <select class="select2 " multiple="multiple" data-placeholder="Modulos" name="modulos[]" style="width: 100%;" required>
                          ...
                          <?php foreach ($modulosselec as $row):?>
                            <?php $c=false ?>
                            <?php if ($linea->idmodulo==$row->idmodulo): ?> 
