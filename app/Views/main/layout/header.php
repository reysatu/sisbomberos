...
<div class="padre_cabesera" id="padre_cabesera">
  <div class="div_p_c">
    ...
    <div class="padre_llamar" id="padre_llamar">
          <div>
            <a href="https://api.whatsapp.com/send?phone=34654087601&text= Hola!%20necesito%20sus%20servicios!" class="a_wspp" target="_blank" ><p>Llamar</p><span class="icon-whatsapp"></span></a>
          </div>
    </div>
    </div>
    ...
    <div class="padre_llamar_r" id="padre_llamar_r">
          <div>
            <a href="https://api.whatsapp.com/send?phone=34654087601&text= Hola!%20necesito%20sus%20servicios!" class="a_wspp_r" target="_blank" ><p>Llamar</p><span class="icon-whatsapp"></span></a>
          </div>
      </div>
